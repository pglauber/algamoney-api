...
//	private String originPermitida = "http://localhost:8000"; // TODO: Configurar para diferentes ambientes
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		resp.setHeader("Access-Control-Allow-Origin", /*originPermitida*/ algamoneyApiProperty.getOrigemPermitida());
		resp.setHeader("Access-Control-Allow-Credentials", "true");
		
		if ("OPTIONS".equals(req.getMethod()) && /*originPermitida*/ algamoneyApiProperty.getOrigemPermitida().equals(req.getHeader("Origin"))) {
